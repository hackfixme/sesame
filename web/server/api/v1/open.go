...
// OpenPost creates firewall rules that allow specified IP addresses to access
// services on this node. The client is expected to already have been authenticated
// with a TLS certificate (mTLS).
